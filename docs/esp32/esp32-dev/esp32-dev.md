...
ESP32 DevKit 32E是基于乐鑫科技的 ESP32-Dev模组基础上开发的一款适用于创客教育的标志性产品，Flash大小4MB，集成 2.4 GHz、Wi-Fi 和蓝牙双模的单芯片方案。

| 产品尺寸 | 51.5*28.4mm | SRAM     |        |
| -------- | ----------- | -------- | ------ |
| 产品重量 |             | ROM      | 4M     |
| 电源输入 | Type-C      | 串口芯片 | CH340G |

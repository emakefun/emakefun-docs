...
### Makecode软件编程
![Makecode_code](magic_bit/Makecode_code.png)
Makecode软件使用方便简介，图形化的编程入门要求低，提高学习者的兴趣，让学习者更加专注于编程逻辑的设计，更好的开发智力。

### Python编程（Mu editor）
![Mu_editor_code](magic_bit/Mu_code.png)
...
## 拓展学习和难题解答
* 交流群
* [百度贴吧](https://tieba.baidu.com/f?kw=microbit)
* [microbit中文社区](http://www.microbitgo.com/)
* [microbit-arduino中文社区](https://www.arduino.cn/forum-121-1.html)
* [microbit电子发烧友](http://www.elecfans.com/tags/microbit/)
* [microbit创客社区](http://mc.dfrobot.com.cn/thread-38057-1-1.html)

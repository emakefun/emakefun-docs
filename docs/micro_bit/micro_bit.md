...
![LEGO1](magic_bit/magicbit_LEGO_1_zh.gif)

![LEGO2](magic_bit/magicbit_LEGO_2_zh.gif)

2. 底座安装完成后，和Magicbit进行拼接。

   ![LEGO3](magic_bit/magicbit_LEGO_3_zh.gif)
...
![code_magicbit_extend_zh](magic_bit/code_magicbit_extend_zh.png)

![code_magicbit_addpackage_zh](magic_bit/code_magicbit_addpackage_zh.png)

![code_magicbit_click_zh](magic_bit/code_magicbit_click_zh.png)
...
### 点击下载按钮
* 点击**`下载`**,     红色箭头所指的按扭![code_magicbit_datadown_zh](magic_bit/magicbit_datadown_zh.png)

### 保存到Microbit的U盘上，在保存过程中micro:bit指示灯会闪烁
* 点击红色箭头所指的地方、选择另存为

![code_magicbit_datasave1_zh](magic_bit/magicbit_datasave1_zh.png)

* 选择MICROBIT的内存盘，点击保存，程序就开始下载

![code_magicbit_datasave2_zh](magic_bit/magicbit_datasave2_zh.png)
...
![magicbit_DCmotor1_zh](magic_bit/magicbit_DCmotor_code_zh.png)
...
![magicbit_motor_code_zh](magic_bit/magicbit_mottor_code_zh.png)
...
![magicbit_RGBCSB](magic_bit/magicbit_RGBCSB_UART_code_zh.png)
...
> 实验现象为：LCD1602液晶第一行显示**`wwllo! emakefun!`**    ，第二行显示**`2019`**       [I2C实验例程源码](magic_bit_code/magicbit_I2C_code_zh.hex)

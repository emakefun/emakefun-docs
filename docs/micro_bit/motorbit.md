...
## 适用人群
micro:bit 多功能电机驱动扩展板适用于：创客竟赛/智力开发/教育培训机构/中小学实验室/创客教育
...
### 正面
![image-20200305102542741](motorbit/motorbit_sign_zh.png)

# 扩展版各单元模块详解

## 电源供电口
![image-20200305094959644](motorbit/motorbit_DC_PCB_zh.png)
- motor:bit 有两个供电接口，一个接线柱类型，一个DC头类型。在使用接线柱供电时，注意电源正负极的连接方向，扩展板接线柱的 + 符号所代表的接线口表示应该连接电源正极线、— 符号所代表的接线口表示应该连接电源负极线
...
## RGB炫彩灯
![motorbit_RGB_zh](motorbit/motorbit_RGB_PCB_zh.png)
...
![motorbit_DCmotor_zh](motorbit/motorbit_MOTOR_PCB_zh.png)
...
## 8路舵机接口
![motorbit_servo_zh](motorbit/motorbit_PWM_PCB_zh.png)
...
* 在使用motor:bit 驱动舵机时，可以通过跳线帽选择不同的供电方式，当跳线帽选择5V时、舵机接线端的红色引脚提供5V：当跳线帽选择 + 时，舵机接线端的红色引脚与连接在接线柱的电源直接连接，电压与连接在接线柱的电源相同
> 舵机控制实验例程
...
![motorbit_motor_zh](motorbit/motorbit_MOTOR_PCB_zh.png)
...
## RGB超声波
![motorbit_RGBCSB_zh](motorbit/motorbit_RGBCSB_PCB_zh.png)
...
## I2C接口
![motorbit_I2C_zh](motorbit/motorbit_I2C_PCB_zh.png)

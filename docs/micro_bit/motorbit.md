...
## 产品特色
1.  通过I2C扩展PWM控制 ，与Micro:Bit主板IO口不存在对应关系
2. 供电方式有接线柱和DC头，可通过开关自由选择，亦可双供电
3. 强力电机和舵机驱动芯片，最大驱动电流可达4A，驱动力强劲
4. 包含多种电压引脚，满足大多数场景需要
5. 与乐高兼容，通过不同的积木搭建、配合Motor:Bit实现更好更多更富创造性的功能，充分发挥学生的创造力
6. 同时支持驱动8路舵机和4路直流电机
7. 支持驱动2路4线步进电机
8. 板载4个RGB全彩灯，无源蜂鸣器
9. 板载红外接收头，通过红外遥控器实现红外线远程控制
10. 一个PH2.0-4Pin RGB超声波防反插接口

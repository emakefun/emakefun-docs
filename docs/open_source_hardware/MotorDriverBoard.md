...
## 基础示例程序
[**Gpio_test**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/base/gpio_test/gpio_test.ino) 控制PCA9685输出口当作普通IO口输出高低电平
...
[**PWM_test**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/base/pwm_test/pwm_test.ino) 这个示例程序为控制PCA9685输出口输出PWM波形
...
[**PS2_test**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/base/ps2_test/ps2_test.ino)PS2手柄测试程序
...
#### [**DC**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/motor_test/dc/dc.ino)四路直流电机测试程序
...
#### [**Servo**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/motor_test/servo/servo.ino)八路舵机测试程序
...
#### [**Stepper**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/motor_test/stepper/stepper.ino) 步进电机测试程序
...
#### [**Encoder**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/motor_test/encoder/encoder.ino)四路编码电机测试程序
...
[**Encoder_pid**](https://github.com/emakefun/MotorDriverBoard/blob/master/arduino_lib/examples/motor_test/encoder_pid/encoder_pid.ino)编码电机PID控制电机速度

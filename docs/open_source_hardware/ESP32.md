...
​		 Maker-ESP32是基于 乐鑫科技的wifi芯片ESP32基础上开发的一款适用于创客教育的标志性产品，集成 2.4 GHz、Wi-Fi 和蓝牙双模的单芯片方案，采用台积电 (TSMC) 超低功耗的 40 纳米工艺，具有超高的射频性能、稳定性、通用性和可靠性，以及超低的功耗。Xtensa® 32-bit LX6 单/双核处理器，运算能力高达 600 MIPS。
...
1. 接上主板，右键点击“我的电脑-->属性-->设备管理器-->端口（COM和LTP）”，如果看到下图所示，则说明驱动已安装。
   ...
   2. 安装驱动
      ...
      **注意：**在Win10系统中，系统会自动下载相对应的驱动，无需自己安装驱动，但是在Win7系统中，就需要按照上述的步骤手动安装驱动。
